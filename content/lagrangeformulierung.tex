...
Der Faktor $b$ beschreibt die Stärke der Wechselwirkung von $A_{\mu}$ mit dem Strom $j^{\mu}$ und entspricht einer Ladung. Er bleibt als empirisch zu bestimmende Größe stehen. Man erhält im Endeffekt aber wieder (4).
