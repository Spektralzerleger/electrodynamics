...
\begin{align*}
\frac{d}{d \epsilon} \text{I}[A + \varepsilon \cdot \delta A] &= \frac{d}{d \epsilon} \left( \int - \frac{1}{2} \d(A + \varepsilon \cdot \delta A) \w \d(A + \varepsilon \cdot \delta A) + (A + \varepsilon \cdot \delta A) \w J \right)
&= \int - \frac{1}{2} \left( \d(A + \varepsilon \cdot \delta A) \w \d(A + \varepsilon \cdot \delta A) + (A + \varepsilon \cdot \delta A) \w J \right)
&= .... 
