...
\begin{align}
\omega \w \star \mu = \left<\omega,\mu \right> \text{vol}, \ \mu \in \Omega^p(\mathcal{M}), \alpha \in \Omega^n(\mathcal{M})
\end{align}
...
Wenden wir nun den $\star$-Operator an, folgt zum Beispiel:  \todo{nochmal nachrechnen}
